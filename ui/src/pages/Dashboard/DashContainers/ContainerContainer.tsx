...
const rows : GridRowsProp = [
    {id: 1, col1:"Container 1", col2:"20%", col3: "0.3", col4:"20%", col5: "20 min", col7:" " },
...
const columns : GridColDef[] = [
    ...
    {field: "col7", headerName: "Container Options", width: 150, renderCell: () =>{ return <button>Delete</button>}}
];
